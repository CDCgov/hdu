...
# dictionary similar adt_names for VXU messages
vxu_names = {}
...
def cleanup_hl7(message):
    """ clean up the HL7 message to ensure proper segment endings """
    cleaned_message = ""
